...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('child_first_name', models.CharField(max_length=100, verbose_name='Ism')),
                ('child_last_name', models.CharField(max_length=100, verbose_name='Familiya')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='education.group', verbose_name='Guruhi')),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='education.users', verbose_name='Foydalanuvchi')),
            ],
            options={
                'verbose_name': 'Parent',
        ...
        migrations.AddField(
            model_name='group',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='education.teacherprofile', verbose_name="O'qituvchi"),
        ),
        migrations.AddField(
